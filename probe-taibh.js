...
const URLS = [
  '/ReInsurance/InwardTreatyReinsurance',
  '/ReInsurance/OutwardTreatyReinsurance',
  '/CategoryReInsurance/RetentionByMajor',
  '/CategoryReInsurance/RetentionByObject',
  '/CategoryReInsurance/RetentionByObjectCar',
  '/ReInsurance/AllocationSearch',
  '/ReInsurance/ProcessingSearch',
  '/ReInsurance/TreatyOutwardSearch',
  '/ReInsurance/TreatyInward',
  '/ReInsurance/Debt',
];
(async () => {
