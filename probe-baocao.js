...
const URLS = [
  '/Report/HealthReport',
  '/Report/DetailedRevenueReport?bc=dtct',
  '/Report/RenewalReport?bc=cantt',
  '/Report/RenewalReport?bc=datt',
  '/Report/BancasReport?bc=1',
  '/Report/BancasReport?bc=2',
  '/Report/BancasReport?bc=3',
  '/Report/BancasReport?bc=4',
  '/Report/BancasReport?bc=5',
  '/Report/SynthesisCertificateReport_receive',
  '/Report/SynthesisCertificateReport',
  '/Report/StaffReport?bc=tshh',
  '/Report/StaffReport?bc=tshhct',
  '/ContractCargo/SearchBCTLO',
  '/AppDashboard/DashBoard',
  '/Report/PointReport?bc=ct',
  '/Report/PointReport?bc=thdv',
];
(async () => {
