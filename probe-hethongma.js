...
const URLS = [
  '/CategorySystem/Unit',
  '/CategorySystem/Department',
  '/CategorySystem/UserAccount',
  '/CategorySystem/Staff',
  '/CategoryOther/MenuIcon',
  '/CategoryInsurance/Customer',
  '/CategoryInsurance/Agency',
  '/CategoryPushNotify/PushNotify',
  '/CategoryPerson/Benefit',
  '/ContractPerson/ProductPackages',
  '/FeeSchedule/FeeSchedule',
  '/CategoryCar/Manufacturer',
  '/CategoryCar/Brand',
  '/CategoryCar/CarType',
  '/CategoryCar/CarGroup',
  '/CategoryProperty/PropertyGroup',
  '/CategoryProperty/PropertyGroupObject',
  '/CategoryProperty/PropertyPremiumRateTables',
