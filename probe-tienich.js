...
const URLS = [
  '/ContractPublic/BrowerEnd',
  '/ContractPublic/BrowserSearch',
  '/Profit/CASearchObjects',
  '/ContractRecive/Search',
  '/ContractRecive/SearchContractPremia',
  '/CoInsurance/CoInsuranceReconciliation',
];
(async () => {
